...
exports.MongoDBGenerator = void 0;
const index_1 = require("./index");
class MongoDBGenerator extends index_1.DatabaseGenerator {
    constructor(config) {
        super(config);
    }
    ...
    convertTablesToCollections(tables) {
    ...
    generateCollection(collection) {
        ...
        for (const [field, config] of Object.entries(collection.schema)) {
            ...
            if (config.default !== undefined)
                code += `    default: ${JSON.stringify(config.default)},\n`;
            code += `  },\n`;
        }
        code += `};\n\n`;
        // Validator
    ...
    generateAggregationPipelines(collections) {
...
exports.MongoDBGenerator = MongoDBGenerator;
