...
module.exports = app;`;
    ...
    generateAuthMiddleware(requirements) {
...
module.exports = router;`;
    ...
    generateAuthRoutes(requirements) {
        return `const express = require('express');
const router = express.Router();
...
module.exports = router;`;
    ...
    generateAuthController(requirements) {
...
module.exports = authController;`;
    ...
    generateAPIController(requirements) {
...
module.exports = User;`;
    ...
    generateModelIndex(requirements) {
        const dbType = requirements.techStack.database || 'mongodb';
        if (dbType === 'mongodb') {
            return `const mongoose = require('mongoose');
...
networks:
  app-network:
    ...
    generateServerTests(requirements) {
...
describe('Server', () => {
  ...
  describe('Security Headers', () => {
    ...
    generateAuthTests(requirements) {
        return `const request = require('supertest');
const app = require('../server');
const User = require('../models/User');
