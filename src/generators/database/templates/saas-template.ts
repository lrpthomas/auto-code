...
export function generateSaasSchema(): SchemaTemplate {
  ...
  const organizationUsersTable: TableConfig = {
  ...
  const subscriptionsTable: TableConfig = {
    name: 'subscriptions',
    fields: [
      {
        name: 'id',
  ...
  const invoicesTable: TableConfig = {
    name: 'invoices',
    fields: [
      {
        name: 'id',
  ...
  const webhooksTable: TableConfig = {
    name: 'webhooks',
    fields: [
      {
        name: 'id',
  ...
  const usageMetricsTable: TableConfig = {
    name: 'usage_metrics',
    fields: [
      {
        name: 'id',
