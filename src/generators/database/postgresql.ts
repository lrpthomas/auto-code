...
export class PostgreSQLGenerator extends DatabaseGenerator {
  ...
  private generateTable(table: TableConfig): string {
  ...
  private generateConstraint(constraint: ConstraintConfig): string {
  ...
  private generateIndexes(table: TableConfig): string {
    let sql = '';
  ...
  private generateRelationships(table: TableConfig): string {
    let sql = '';
  ...
  private generateStoredProcedure(procedure: StoredProcedureConfig): string {
  ...
  private generateTrigger(trigger: TriggerConfig): string {
