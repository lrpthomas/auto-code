...
export class FastAPIGenerator {
  ...
  public async generateAPI(requirements: AppRequirements): Promise<GeneratedApp> {
    ...
    projectStructure['requirements.txt'] = this.generateRequirements(requirements);
  ...
  private generateMain(requirements: AppRequirements): string {
    return `"""
...
if __name__ == "__main__":
  ...
  private generateConfig(requirements: AppRequirements): string {
...
def verify_password_reset_token(token: str) -> Optional[str]:
  ...
  private generateDatabase(requirements: AppRequirements): string {
...
async def get_optional_current_user(
  ...
  private generateAPIRouter(requirements: AppRequirements): string {
...
${requirements.features.map(feature => {
  ...
  private generateAuthEndpoints(): string {
...
async def logout(
  ...
  private generateUserEndpoints(): string {
...
class User(Base):
  ...
  private generateUserSchemas(): string {
    return `"""User schemas."""
...
class PasswordReset(BaseModel):
  ...
  private generateTokenSchemas(): string {
...
class RefreshToken(BaseModel):
  ...
  private generateBaseCRUD(): string {
...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
  ...
  private generateUserCRUD(): string {
...
user = CRUDUser(User)`;
  ...
  private generateEmailUtils(): string {
...
def send_new_account_email(email_to: str, username: str, password: str) -> None:
  ...
  private generateSecurityUtils(): string {
...
def get_client_ip(request: Any) -> str:
  ...
  private generateRequirements(requirements: AppRequirements): string {
...
gunicorn==21.2.0`;
  ...
  private generatePyProject(requirements: AppRequirements): string {
    return `[build-system]
requires = ["hatchling"]
...
LOG_LEVEL=INFO`;
  ...
  private generateAlembicConfig(): string {
...
datefmt = %H:%M:%S`;
  ...
  private generateAlembicEnv(): string {
...
if context.is_offline_mode():
  ...
  private generateAlembicScript(): string {
    return `"""${message}
...
def test_admin_data():
  ...
  private generateMainTests(): string {
...
class TestAuth:
  ...
  private generateUserTests(): string {
